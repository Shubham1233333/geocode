...
#         with open(self.input_csv, 'rt', encoding='utf-8') as csvfile:
...
#                     ("Type: ", exc_type, "Line No.:", exc_tb.tb_lineno)
#                     pass

#             # save results into files
#             with codecs.open('final_results.json', 'w', encoding="utf-8") as outfile:
#                 json.dump(self.final_results, outfile, ensure_ascii=False)
#             with codecs.open('geocode_results.json', 'w', encoding="utf-8") as outfile:
...
#         print("kejfhskjfhdiuhghdriughdrsiughfdughdughdfuighudfhgdrhgudrhgdrhgh",address)
...
#                     row['CITY'], api_result, lng, lat, formatted_address,
...
#                         row = [item.decode('utf-8') if isinstance(
...
#                                          'place_id': row[8],
#                                          'type': row[9], 'status': row[10],
#                                          'street_number': row[11],
#                                          'route': row[12], 'locality': row[13],
#                                          'administrative_area_level_2': row[14],
#                                          'administrative_area_level_1': row[15],
#                                          'country': row[16],
#                                          'postal_code': row[17],
#                                          'CODE': row[18],
#                                          'X': row[19],
